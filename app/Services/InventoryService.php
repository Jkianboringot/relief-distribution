...
class InventoryService
{
    ...
    //check: it must check first if barangay and ingredient alrady exist in pivot table
            ...
            return DB::transaction(
                function () use ($data) {
                    ...
                    foreach ($data['productList'] as $listItem) {
                        ...
                        //                     $existingProducts = $barangay->products()
                        // ->whereIn(
                        //     'product_id',
                        ...
                        if ($existting) {
                            $barangay->products()->updateExistingPivot(
                                $productID,
                                [
